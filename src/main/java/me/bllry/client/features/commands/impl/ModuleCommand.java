...
public class ModuleCommand
    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : bllry.moduleManager.getCategories()) {
                String modules = category.getName() + ": ";
                for (Module module1 : bllry.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = bllry.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = bllry.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
