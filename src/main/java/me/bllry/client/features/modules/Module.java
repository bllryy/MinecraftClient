package me.bllry.client.features.modules;
...
import me.bllry.client.event.impl.Render3DEvent;
...
import me.bllry.client.manager.ConfigManager;
...
public class Module extends Feature implements Jsonable {
    ...
    public void setDisplayName(String name) {
        Module module = bllry.moduleManager.getModuleByDisplayName(name);
        Module originalModule = bllry.moduleManager.getModuleByName(name);
