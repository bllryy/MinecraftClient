...
import me.bllry.client.event.impl.ClientEvent;
import me.bllry.client.features.commands.Command;
import me.bllry.client.features.gui.OyVeyGui;
...
public class ClickGui
    ...
    public void onSettingChange(ClientEvent event) {
        if (event.getStage() == 2 && event.getSetting().getFeature().equals(this)) {
            if (event.getSetting().equals(this.prefix)) {
                bllry.commandManager.setPrefix(this.prefix.getPlannedValue());
                Command.sendMessage("Prefix set to " + Formatting.DARK_GRAY + bllry.commandManager.getPrefix());
            }
            bllry.colorManager.setColor(this.red.getPlannedValue(), this.green.getPlannedValue(), this.blue.getPlannedValue(), this.hoverAlpha.getPlannedValue());
        }
    }
    ...
    @Override
    public void onLoad() {
        bllry.colorManager.setColor(this.red.getValue(), this.green.getValue(), this.blue.getValue(), this.hoverAlpha.getValue());
        bllry.commandManager.setPrefix(this.prefix.getValue());
    }
