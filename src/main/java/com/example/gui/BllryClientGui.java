...
public class BllryClientGui extends Screen {
    private static BllryClientGui oyveyGui;
    private static BllryClientGui INSTANCE;

    static {
        INSTANCE = new BllryClientGui();
    }
    ...
    public static BllryClientGui getInstance() {
        if (INSTANCE == null) {
            INSTANCE = new BllryClientGui();
        }
        return INSTANCE;
    ...
    public static BllryClientGui getClickGui() {
        return BllryClientGui.getInstance();
    }
